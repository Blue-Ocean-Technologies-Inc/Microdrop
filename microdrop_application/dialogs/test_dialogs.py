...
class DialogTestWindow(QMainWindow):
    ...
    def create_logger_integration_section(self, parent_layout):
        ...
        self.logger_enabled_checkbox.stateChanged.connect(self.toggle_logger_dialogs)
    ...
    def show_info_dialog(self):
        ...
        result = show_information(
            parent=self,
            title="Information",
            message="This is an information dialog. It provides general " "information to the user without requiring immediate " "action.",
        )
    ...
    def show_success_dialog(self):
        ...
        result = show_success(
            parent=self,
            title="Success",
            message="The operation completed successfully! All files have " "been processed and saved to the specified location.",
        )
    ...
    def show_warning_dialog(self):
        ...
        dialog = WarningAlertDialog(
            parent=self,
            title="Warning",
            message="This is a warning dialog. It alerts the user to " "potential issues that may require attention.",
            cancel=True,
        )
    ...
    def show_error_dialog(self):
        ...
        result = show_error_alert(
            parent=self,
            title="Error",
            message="An error has occurred while processing your request. " "Please check your settings and try again.",
        )
    ...
    def show_error_with_details(self):
        ...
        result = show_error_alert(
            ...
            message="Failed to connect to the DropBot device. Please check " "the connection and try again.",
...
/dev/ttyUSB0: [Errno 2] No such file or directory: '/dev/ttyUSB0'""",
    ...
    def show_question_dialog(self):
        ...
        result = show_question(
            ...
            message="Are you sure you want to delete the selected protocol? " "This action cannot be undone.",
            yes_text="Delete",
            no_text="Cancel",
        )
    ...
    def show_unsaved_changes(self):
        ...
        dialog = WarningAlertDialog(
            ...
            message="You have unsaved changes to the current experiment. " "What would you like to do?",
            cancel=True,
        )
        result = dialog.show_dialog()
    ...
    def show_non_modal_dialog(self):
        ...
        dialog = InformationDialog(
            ...
            message="This is a non-modal dialog. You can interact with the " "main window while this dialog is open.",
            modal=False,
        )
    ...
    def log_error(self):
        ...
        error_msg = "This is an error logged through the logger integration " "system. It automatically shows a dialog when dialogs are " "enabled."
    ...
    def log_warning(self):
        ...
        warning_msg = "This is a warning message from the logger. It shows as a " "warning-style dialog."
    ...
    def show_save_success(self):
        ...
        show_success(
            ...
            message="Protocol 'Mixing_Experiment_v2.json' has been saved " "successfully to the protocols folder.",
        )
