...
ICON_PLAY            = "play_arrow"  # play
ICON_PAUSE           = "pause"  # pause
ICON_RESUME          = "resume"  # resume
...
ICON_ARROW_UPWARD    = "arrow_upward"    # magnet up (engage)
ICON_ARROW_DOWNWARD  = "arrow_downward"  # magnet down (disengage)
