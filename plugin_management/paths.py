...
Legacy (zip-install) discovery dirs + sys.path wiring (removed in the
conda-package migration's teardown task), plus the local conda channel dir that
holds installed plugin .conda files."""
