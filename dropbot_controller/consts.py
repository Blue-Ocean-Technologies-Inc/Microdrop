...
# Dropbot Services Topics -- Offered by default from the dropbot monitor
# mixin in this package
...
TEST_ON_BOARD_FEEDBACK_CALIBRATION = (
    "dropbot/requests/test_on_board_feedback_calibration"
)
...
# capacitance threshold to detect droplets. This is the multiplier to the
